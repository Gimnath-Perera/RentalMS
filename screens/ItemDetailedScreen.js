          ...
          <View style={styles.rect}>
            <View style={styles.amarylissPotatoColumnRow}>
              <View style={styles.amarylissPotatoColumn}>
                <Text style={styles.amarylissPotato}>Item Name</Text>
                <View style={styles.image3Row}>
                  {/* <Image
                    ...
                    style={styles.image3}
                  ></Image> */}
                  <Text style={styles.maimoSweden}>Item Description</Text>
                </View>
              </View>
              {/* <Image
            ...
            <View style={styles.rect2}>
              <View style={styles.image4Row}>
                ...
                {/* <Image
                  ...
                  style={styles.image5}
                ></Image> */}
                <Text style={styles.waterWeekly}>Available</Text>
              </View>
            </View>
            <View style={styles.rect2}>
              <View style={styles.image4Row}>
                {/* <Image
                  ...
                  style={styles.image4}
                ></Image> */}
                <Text style={styles.needSunlight}>Quantity: </Text>
                {/* <Image
                  source={require('../assets/images/watering.png')}
                  resizeMode='contain'
                  style={styles.image5}
                ></Image> */}
                <Text style={styles.waterWeekly}>4</Text>
              </View>
            </View>
