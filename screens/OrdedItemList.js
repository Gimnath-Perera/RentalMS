...
class OrdedItemList extends Component {
          ...
          <View style={styles.rect}>
            <View style={styles.otherColumnRow}>
              <View style={styles.otherColumn}>
                <Text style={styles.other}>Items</Text>
                <Text style={styles.pestsDiseases}>
                  Previously orderd items
                </Text>
              </View>
            </View>
            <Text style={styles.loremIpsum}>Browse throgh items.</Text>
          </View>
        </View>
      </View>
    );
