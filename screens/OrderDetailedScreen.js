...
class OrderDetailedScreen extends Component {
  render() {
    return (
          ...
          <View style={styles.rect}>
            <View style={styles.amarylissPotatoColumnRow}>
              <View style={styles.amarylissPotatoColumn}>
                <Text style={styles.amarylissPotato}>Oder ID: #OR78265</Text>
            ...
            <View style={styles.rect2}>
              <View style={styles.image4Row}>
                {/* <Image
                  ...
                  style={styles.image4}
                ></Image> */}
                <Text style={styles.needSunlight}>Date created: </Text>
                {/* <Image
                  source={require('../assets/images/watering.png')}
                  resizeMode='contain'
                  style={styles.image5}
                ></Image> */}
                <Text style={styles.waterWeekly}>2019.02.30</Text>
              </View>
            </View>
            ...
            <View style={styles.rect2}>
              <View style={styles.image4Row}>
                {/* <Image
                  ...
                  style={styles.image4}
                ></Image> */}
                <Text style={styles.needSunlight}>Returned date: </Text>
                {/* <Image
                  source={require('../assets/images/watering.png')}
                  resizeMode='contain'
                  style={styles.image5}
                ></Image> */}
                <Text style={styles.waterWeekly}>2019.03.30</Text>
              </View>
            </View>
            <View style={styles.rect2}>
              <View style={styles.image4Row}>
                ...
                {/* <Image
                  ...
                  style={styles.image5}
                ></Image> */}
                <Text style={styles.waterWeekly}>Returned</Text>
              </View>
            </View>
